...
const messages = {
  'zh-CN': {
    ...
    loginSubtitleLogin: '登录以开始您的五子棋之旅',
  ...
  'zh-TW': {
    ...
    loginSubtitleLogin: '登錄以開始您的五子棋之旅',
  ...
  'en-US': {
    ...
    loginSubtitleLogin: 'Login to start your Gomoku journey',
  ...
  'ja-JP': {
    ...
    loginSubtitleLogin: 'ログインして五目並べの旅を始めましょう',

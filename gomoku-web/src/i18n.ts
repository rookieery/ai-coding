...
const messages = {
  'zh-CN': {
    ...
    agentTitle: '棋林智能体',
    agentGreeting: '你好！我是棋林智能体。我可以帮你分析五子棋开局、解答规则疑问，或者提供对局策略。请在下方输入你的问题。',
  ...
  'zh-TW': {
    ...
    agentTitle: '棋林智能體',
    agentGreeting: '你好！我是棋林智能體。我可以幫你分析五子棋開局、解答規則疑問，或者提供對局策略。請在下方輸入你的問題。',
  ...
  'en-US': {
    ...
    agentGreeting: 'Hello! I am Qilin Agent. I can help you analyze Gomoku openings, answer rule questions, or provide game strategies. Please enter your question below.',
  ...
  'ja-JP': {
    ...
    agentTitle: '棋林エージェント',
    agentGreeting: 'こんにちは！棋林エージェントです。五目並べの序盤の分析、ルールの疑問への回答、対局戦略の提供などができます。下に質問を入力してください。',

...
export const themes: Record<ThemeKey, ThemeColors> = {
  ...
  zen: {
    ...
    pieceTextPrimary: 'text-[#8B0000]',
    pieceTextSecondary: 'text-[#1A1A1A]',
    textPrimary: 'text-gray-800 dark:text-gray-800',
    textSecondary: 'text-gray-500 dark:text-gray-500',
  },
  cyber: {
    ...
    pieceTextPrimary: 'text-[#F43F5E] drop-shadow-md',
    pieceTextSecondary: 'text-[#2DD4BF] drop-shadow-md',
